...
const MetaBalls: React.FC<MetaBallsProps> = ({
    ...
    useEffect(() => {
        ...
        const dpr = 1; // Assuming dpr=1 for performance or consistency as per original
        ...
        // const scene = new Transform(); // Not strictly needed if we just render mesh, but useful for hierarchy
        // mesh.setParent(scene);
        // Original code used `const scene = new Transform(); mesh.setParent(scene); renderer.render({ scene, camera });`
        // I will follow that.
        ...
        function onPointerMove(e: PointerEvent) {
            ...
            // Coordinates normalized and possibly adjusted for aspect? 
            // The shader uses `(iMouse.xy - iResolution.xy * 0.5) * scale`
            // Here pointerX/Y are passed as iMouse.xy.
            // So they should be in canvas pixel coordinates?
            // Original code: pointerX = (px / rect.width) * gl.canvas.width;
        ...
        function update(t: number) {
            ...
            for (let i = 0; i < effectiveBallCount; i++) {
                ...
                // Update the existing Vec3 objects in place
